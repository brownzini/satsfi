    ...
    case "brain-ai":
      return (
        <Svg
          ...
          viewBox="0 0 500 500"
        >
          <style type="text/css">{brainAiStyle}</style>
          <g id="border">
            <path
              className="st0"
    ...
    case "fee":
      return (
        ...
        >
          <path
            className="st2"
            d="M23,3H7C6.4,3,6,3.4,6,4v22l3-2l3,2l3-2l3,2l3-2l3,2V4C24,3.4,23.6,3,23,3z M20,20h-4v-4h4V20z M20,13H10v-2h10  V13z M20,9H10V7h10V9z"
          />
        </Svg>
      );
    case "export":
    ...
    case "addSurvey":
      return (
        <svg
          ...
          viewBox="0 0 32 32"
        >
          <style type="text/css">{surveyStyle}</style>
          <g>
            <path
      ...
      return (
        ...
        >
          ...
          <g>
            <path
              className="st0"
              d="M125.156,243.656c2.656-1.734,4-4.516,4-8.328c0-3.938-1.203-6.766-3.594-8.438
		c-2.406-1.656-6.172-2.516-11.281-2.516h-9.688v21.906h8.844C118.578,246.281,122.484,245.406,125.156,243.656z"
            />
            <path
              className="st0"
              d="M128.953,268.391c-1.203-0.906-2.734-1.625-4.609-2.109c-1.891-0.484-4.156-0.734-6.844-0.734h-12.484v22.219
		...
		c0.5-1.406,0.75-2.891,0.75-4.453c0-1.641-0.266-3.125-0.828-4.438C131.047,270.453,130.156,269.328,128.953,268.391z"
            ...
            <path
              className="st0"
              d="M230.781,256c0-63.703-51.672-115.391-115.406-115.391C51.656,140.609,0,192.297,0,256
		...
		C160.547,280.625,159.688,284.484,157.969,288.031z"
            ...
            <path
              className="st0"
              d="M155.938,121.703c27.281-21.391,61.531-34.156,98.906-34.156c0.469,0,0.922,0.047,1.406,0.047l-12.047,36.422
		...
		c-1.234,1.25-2.406,2.531-3.609,3.797c0.188,0,0.375-0.016,0.563-0.016C129.516,115.375,143.156,117.594,155.938,121.703z"
            ...
            <path
              className="st0"
              d="M356.063,390.297c-27.281,21.391-61.531,34.141-98.906,34.156c-0.469,0-0.938-0.047-1.406-0.047l12.047-36.422
		...
		c1.234-1.234,2.406-2.531,3.609-3.797c-0.188,0-0.375,0.016-0.563,0.016C382.469,396.625,368.844,394.391,356.063,390.297z"
            ...
            <path
              className="st0"
              d="M396.625,140.609c-63.734,0-115.406,51.688-115.406,115.391c0,63.734,51.672,115.391,115.406,115.391
		...
		z"
            ...
            <path
              className="st0"
              d="M400.375,217.5h-24.563c-3.906,0-7.094,3.172-7.094,7.094v72.422c0,3.906,3.188,7.094,7.094,7.094h3.578
    ...
    case "test":
      return (
        ...
        >
          ...
          <line className="cls-1" x1="7.23" y1="1.5" x2="16.77" y2="1.5" />
          ...
          <path
            className="cls-1"
            d="M19.64,14.86a7.63,7.63,0,0,0-4.78-7.07V1.5H9.14V7.79a7.63,7.63,0,0,0,2.18,14.68c.22,0,.45,0,.68,0s.46,0,.68,0A7.65,7.65,0,0,0,19.64,14.86Z"
          />
        </BaseSvg>
      );
    case "trackDonate":
      ...
      return (
        ...
        >
          <g fill="#6695d3">
            ...
            <path
              d="m 3 3 v 7 h 10 v -4.171875 l -3.585938 3.585937 c -0.773437 0.773438 -2.054687 0.773438 -2.828124 0 c -0.773438 -0.773437 -0.773438 -2.058593 0 -2.832031 l 3.585937 -3.582031 z m 0 0"
              fillOpacity="0.34902"
            />
          </g>
        </BaseSvg>
